...
CREATE OR REPLACE FUNCTION public.get_funnel_stats(period_minutes integer DEFAULT 30)
RETURNS TABLE (
  visitors bigint,
  quiz_started bigint,
...
GRANT EXECUTE ON FUNCTION public.get_funnel_stats(integer) TO anon, authenticated;